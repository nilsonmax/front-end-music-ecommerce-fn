...
export const InputUp = styled.input`
  ${tw`p-1 my-1.5 border rounded-md outline-none placeholder-[#0A0A0A] border-[#5497A7] focus:border-[#2B4570] focus:shadow-md shadow-[#2B4570]`}
`;

export const InputDown = styled.input`
  ${tw`w-full p-1 my-1.5 border rounded-md outline-none placeholder-[#0A0A0A] border-[#5497A7] focus:border-[#2B4570] focus:shadow-md shadow-[#2B4570]`}
`;

export const Select = styled.select`
  ${tw`p-1 border rounded-md border-[#5497A7] focus:border-[#2B4570] focus:shadow-md shadow-[#2B4570]`}
`;

export const TextArea = styled.textarea`
  ${tw`w-full p-1 my-1.5 border rounded-md border-[#5497A7] outline-none placeholder-[#0A0A0A] focus:border-[#2B4570] focus:shadow-md shadow-[#2B4570]`}
`;
