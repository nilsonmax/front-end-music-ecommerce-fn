                        ...
                        <div class="max-w-screen-xl px-4 md:px-8 mx-auto ">
                            <div class="grid sm:grid-cols-2 gap-8 sm:gap-12 shadow-2xl mb-4">
                                ...
                                <div class="flex flex-col justify-center items-center sm:items-start md:py-24 lg:py-32 xl:py-64">
                                    ...
                                    <p class="inline-block mb-6 bg-highlight hover:bg-orange-600 active:bg-orange-700 focus-visible:ring ring-orange-300 text-background text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-40 py-3">Buy!</p>
