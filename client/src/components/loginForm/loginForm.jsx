          ...
          <form class="max-w-lg  mx-auto bg-white ">
            ...
            <div class="flex flex-col gap-4 p-4 md:p-8">
              <div>
                ...
                <input onChange={e => { handledChange(e) }} placeholder='userName...' type="text" name="userName" class="border w-full bg-slate-300  text-dark  focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
              </div>

              <div className=''>
                <label for="password" class="inline-block text-dark  text-sm sm:text-base mb-2">Password</label>
                <input type="password" placeholder='password...' onChange={e => { handledChange(e) }} name="password" class="border w-full bg-slate-300  text-dark  focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
              </div>
